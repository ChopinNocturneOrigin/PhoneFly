	...
	<form name="frm" method="post">
		...
		<table id="BUList">
			<tr>
				...
				<input type="text" name="subject" size="47" value="${bannerVO.subject}"></td>
			</tr>

<tr>
				<th>순위</th>
				<td width="642">
				<select id ="BOrder" name="order_seq">
			...
			<tr>
			 <th>텍스트 위치 수정</th>
			  <td width="343" colspan="5">
			 X축:<input type="text" name="top" size="5" value="${bannerVO.top}">PX
			 <br>Y축:<input type="text" name="left" size="5" value="${bannerVO.left}">PX
			 	 </td>
			</tr>
			...
			<tr>
				...
				현재	비디오 : <img src="admin_images/${bannerVO.image}" width="200px;"><br>
