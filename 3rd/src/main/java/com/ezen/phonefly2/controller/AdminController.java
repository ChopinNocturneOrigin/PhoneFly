...
public class AdminController {
	...
	@PostMapping("/fileup")
	@ResponseBody
	public HashMap<String, Object> fileup(@RequestParam("fileimage") MultipartFile file, HttpServletRequest request, Model model) {
	...
	@PostMapping("/fileupImg")
	@ResponseBody
	public HashMap<String, Object> fileupImg(@RequestParam("fileimage") MultipartFile file, HttpServletRequest request, Model model) {
		HashMap<String, Object> result = new HashMap<String, Object>();
	...
	@PostMapping("/fileupImgE")
	@ResponseBody
	public HashMap<String, Object> fileupImgE(@RequestParam("fileimage") MultipartFile file, HttpServletRequest request, Model model) {
		HashMap<String, Object> result = new HashMap<String, Object>();
	...
	public ModelAndView admin_login(@RequestParam(value="workId", required=false) String workId, @RequestParam(value="workPwd", required=false) String workPwd, HttpServletRequest request ) {
	...
	public String changeOrder(HttpServletRequest request, @RequestParam("bseq") int bseq, @RequestParam("changeval") int changeval) {
		String useyn;
		if (changeval > 5) {
			useyn = "N";
		}
	...
	public String bannerUpdate(HttpServletRequest request,BannerVO bannervo) {
	...
	public String bannerUpdateForm(Model model, HttpServletRequest request, BannerVO bannervo) {
		if( bannervo.getVideo() == null  || bannervo.getVideo().equals("")) {
			bannervo.setVideo(request.getParameter("oldfilename"));
		}
	...
	public String adminQnaReply(@RequestParam("qseq") int qseq, @RequestParam("reply") String reply) {
	...
	public String adminNoticeUpdateForm(Model model, HttpServletRequest request, NoticeVO noticevo) {
	...
	public String adminNoticeUpdate(HttpServletRequest request,NoticeVO noticeVO) {
		cs.updateNotice(noticeVO);
		return "redirect:/adminNoticeList";
	}

	@RequestMapping("/adminNoticeDelete")
	public String adminNoticeDelete(HttpServletRequest request, @RequestParam("nseq") int nseq) {
	...
	public String adminEventUpdateForm(Model model, HttpServletRequest request, EventVO eventvo) {
	...
	public String adminEventUpdate(HttpServletRequest request,EventVO eventvo) {
		if (eventvo.getImage() == null || eventvo.getImage().equals("")) {
	...
	public String adminEventDelete(HttpServletRequest request, @RequestParam("eseq") int eseq) {
		cs.deleteEvent(eseq);
		return "redirect:/adminEventList";
	}

	@RequestMapping("adminBannerView")
	public ModelAndView adminBannerView(HttpServletRequest request, @RequestParam("bseq") int bseq) {
		ModelAndView mav = new ModelAndView();
