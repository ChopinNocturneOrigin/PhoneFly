						...
						<div class="od-selectors">
							<table>
								...
								<tr>
									<th>상태</th>
									<td>
										<select name="result" id="admin-orderdetail-combobox">
											<c:choose>
								...
								<tr>
									<th>통신사</th>
									<td>
										<img src="images/common/tong-${fn:toLowerCase(orderDetailVO.cname)}.png" />
									</td>
								</tr>
								<!-- 가입종류 : 기기변경 / 통신사이동 -->
								<tr>
								...
								<tr>
									<th>요금제</th>
									<td>
										${orderDetailVO.rname}|월 
										<fmt:formatNumber value="${orderDetailVO.charge}" type="number" />원
										<br /> 데이터 ${orderDetailVO.dataplan} / 음성 ${orderDetailVO.timeplan} / ${orderDetailVO.textplan}
									</td>
								</tr>
								<!-- 할인방법
										...
										<c:choose>
											...
											<c:otherwise>
												<c:choose>
													...
													<c:otherwise>
														선택약정할인 - 총 
														<fmt:formatNumber value="${orderDetailVO.charge / 4 * orderDetailVO.buyplan}" type="number" />원
														<br />
														(25% 요금할인 / 약정기간동안 매월 기본료 25%할인)
													</c:otherwise>
												</c:choose>
				...
				<div class="od-inner-right-wrap">
					<div class="od-inner-right">
						...
						<div class="od-pricebox-wrap">
									...
									<ul class="pdd-right-inside-padding">
										...
										<li>
											<div class="txt-al-r float-r">
												<span class="float-r pdd-price-big">
													<span class="float-r pdd-big-inside">&nbsp;원</span>
													<span class="pdd-mtotal-out">
														<fmt:formatNumber value="${orderDetailVO.mtotal}" type="number" />
													</span>
												</span>
											</div>
										</li>
											...
											<div class="pdd-right-inside-padding">
												...
												<div class="txt-al-r pdd-price-middle float-r pdd-dcmonth-out pdd-plan-chk">
													<c:choose>
														...
														<c:otherwise>
															<fmt:formatNumber value="${orderDetailVO.dcmonth}" type="number" />
														</c:otherwise>
													</c:choose>
												</div>
											</div>
											...
											<li class="discount-method-2">
												<div class="pdd-right-inside-padding pdd-right-inside-padding-white">
													...
													<div class="float-r pdd-text-red discount-value-b-text">
														-
														<fmt:formatNumber value="${orderDetailVO.charge / 4}" type="number" />
													</div>
												</div>
											</li>
										</c:if>
							...
							<div class="bottom-btn-container btn-group">
								<div>
									<input type="button" class="btn" value="목록" onclick="location.href='adminOrderList';" />
								</div> &nbsp;&nbsp;&nbsp;
								<div>
