	...
	<div class="support-right-content card-normal">
		<div id="qna-wrap-inner"class="support-inner-wrap">
			...
			<table id="board-table-detail">
				...
				<tr>
					<th>번호<hr class="board-event-hr-left"/></th><td class="board-detail-no">${qnaVO.qseq}<hr class="board-event-hr-right"/></td>
				</tr>
				<tr>
...
학교교육 및 평생교육을 포함한 교육제도와 그 운영, 교육재정 및 교원의 지위에 관한 기본적인 사항은 법률로 정한다. 국회의원은 국회에서 직무상 행한 발언과 표결에 관하여 국회외에서 책임을 지지 아니한다.
	...
	학교교육 및 평생교육을 포함한 교육제도와 그 운영, 교육재정 및 교원의 지위에 관한 기본적인 사항은 법률로 정한다. 국회의원은 국회에서 직무상 행한 발언과 표결에 관하여 국회외에서 책임을 지지 아니한다.
				...
				<tr><td class="board-submit-line" colspan="3">
					<input type="button" class="submit submit-blue board-submit" value="삭제하기" onclick="confirmDeleteQna();" />
					<input type="button" class="submit submit-blue board-submit" value="수정하기" onclick="location.href='pf.do?command=qnaUpdateform';" />
