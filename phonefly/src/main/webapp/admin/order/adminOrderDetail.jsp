				...
				<div class="od-inner-right">
					...
					<div class="od-pricebox-wrap">
						...
						<li id="od-li-submit-wrap">
							<!-- 버튼 -->
							<div>
								<input type="button" class="cancel board-submit" value="목록으로" onclick="location.href='pf.do?command=adminOrderList';" />
								<input type="submit" class="submit submit-blue board-submit" value="수정하기" />
							</div>
							<!-- //버튼 -->
						</li>
