...
<div id="main-card-box">
    ...
    <p>제1조(목적)<br />
이 약관은 주식회사 이루다 (전자상거래 사업자)가 운영하는 PhoneFly&nbsp;사이버 몰(이하 &ldquo;몰&rdquo;이라 한다)에서 제공하는 인터넷 관련 서비스(이하 &ldquo;서비스&rdquo;라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br />
