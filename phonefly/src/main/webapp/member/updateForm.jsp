	...
	<form method="post" name="joinForm" action="pf.do">
		...
		<fieldset>
			...
			<div class="form-floating input-group mb-3">
				<input type="text" name="id" size="20" id="join-id" class="form-control" placeholder=" 아이디를 입력하세요" maxlength="20" aria-describedby="button-addon1" value="${loginUser.id}" disabled /><label for="join-id">아이디</label>
		...
		<fieldset>
			<legend>추가 정보</legend>
			<div class="form-floating input-group mb-3">
				<input type="text" name="zipnum" id="join-zipnum" class="form-control" size="20" placeholder=" 주소찾기를 누르세요" aria-describedby="button-addon2" value="${loginUser.zipnum}" disabled /><label for="join-zipnum">우편번호</label>
				<input type="button" value="주소 찾기" id="button-addon2" class="btn btn-secondary" class="join-form-input" onclick="post_zip();" />
			</div>
			<div class="form-floating mb-3">
				<input type="text" name="address1" id="join-address1" class="form-control" size="50" placeholder=" 주소찾기를 누르세요" value="${loginUser.address1}" disabled /><label for="join-address1">주소</label>
			</div>
			<div class="form-floating mb-3">
