...
<div class="wrap_main_banner">
	<div class="main_banner">
		<ul>
			...
			<li>
				<video class="movie_object" src="videos/movie2.mp4" autoplay muted loop preload="auto" ></video>
				<div id="banner_text2">
					<!-- 제품 설명 2 -->
					<h1>iPhone 13</h1>
			...
			<li>
				<video class="movie_object" src="videos/movie3.mp4" autoplay muted loop preload="auto" ></video>
				<div id="banner_text3">
					<!-- 제품 설명 3 -->
					<h1>갤럭시 S23 Ultra</h1>
